...
<h:head codeedit="true" validity="true"></h:head>
 ...
 <div style="height: 100%;">
	<div id="rows1">
		...
		<div style="display:none;"><textarea name="phoneDefaultPage" id="phoneDefaultPage">${phoneDefaultPage }</textarea></div>
     	<div id="div-content" class="row1-content">
		...
		<div class="row1-bottom">
		   ...
		   <input class="row-button-title active-button" style="width: 93px;vertical-align:middle;margin-right: 1px;font-size: 11px;" type="button" value="保存为常用模板" onclick="commonsubmit();"/>
		   </div>
		   </div>
