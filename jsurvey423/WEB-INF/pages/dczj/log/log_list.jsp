...
<h:import type="css" path="/resources/dczj/layui/css/layui.css"></h:import>
<h:import type="js" path="/resources/dczj/layui/layui.js"></h:import>
...
<body>
	...
	<input type="hidden" name="date" id="date" value="${date }"/>
		...
		<button class="btn btn-primary" data-type="reload">搜索</button>
	</div>
