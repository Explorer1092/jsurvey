...
<script type="text/javascript">
 layui.use('table', function(){
	  ...
	  table.render({
	    ...
	    ,page: true
	    ,where: {dczjid:dczjid,answid:answid,quesid:quesid,starttime:starttime,endtime:endtime}
	    ,cols: [[ //表头
...
function openExaminePage(contentid){
	openDialog('${pageContext.request.contextPath}/manager/count/showexaminepage.do?contentid='+contentid,600,400,{title:'答案详情'});
};
function exportExcel(){
	iframeSubmit("exportansandrep.do?dczjid=${dczjid}&answid=${answid}&quesid=${quesid}&starttime=${starttime}&endtime=${endtime}"); 
}
</script>
</html>