...
@Controller
@RequestMapping("manager/quesbank")
public class QuesBankMenu {
...
//		isDisabled = StringUtil.getSafeString(isDisabled);
		...
		for (DCZJ_WebSite web : webList) {
			tree.addNode(TreeNode.getInstance(web.getIid() + "", webid+"", web.getName(),"/manager/dczj/quesbanktitle.do", web.getIsParent(), false)
