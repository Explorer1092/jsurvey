...
public class QuesEditController {
	...
	public ModelAndView showQuesEdit(Integer dczjid) {
		...
		int num = quesInfoService.findNum(dczjid);
		int sumscore = quesInfoService.findScore(dczjid);
		...
		content = styleService.parseQuesFront(dczjid + "",confMap, settingEn, content,index);
