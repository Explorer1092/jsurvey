 ...
 * 
 */
@Table(name = Tables.RADIORECO)
@Indexes({
	@Index(fieldNames={"dczjid"},indexName="IDX_SRR_FORMID"),
	@Index(fieldNames={"quesid"},indexName="IDX_SRR_QUESID"),
	@Index(fieldNames={"answid"},indexName="IDX_SRR_ANSWID"),
	@Index(fieldNames={"ip"},indexName="IDX_SRR_IP"),
	@Index(fieldNames={"unid"},indexName="IDX_SRR_UNID")
	})
public class RadioReco implements Serializable {
