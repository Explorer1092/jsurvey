 ...
 * 
 */
@Table(name = Tables.CHECKEDBOXRECO)
@Indexes({
	@Index(fieldNames={"quesid"},indexName="IDX_SCBR_QUESID"),
	@Index(fieldNames={"dczjid"},indexName="IDX_SCBR_FORMID"),
	@Index(fieldNames={"answid"},indexName="IDX_SCBR_ANSWID"),
	@Index(fieldNames={"unid"},indexName="IDX_SCBR_UNID")
})
public class CheckedBoxReco implements Serializable {
