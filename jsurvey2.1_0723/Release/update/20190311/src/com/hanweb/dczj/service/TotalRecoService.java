...
public class TotalRecoService {
	...
	public List<TotalReco> findSubmitRecoListsByFormid(String dczjid, int page, int pagesize, String starttime, String endtime){
		return totalRecoDAO.findSubmitRecoListsByFormid(dczjid, page, pagesize, starttime, endtime);
	}
	...
	public List<TotalReco> findSubmitRecoListsByFormid(String dczjid, String starttime, String endtime){
		...
		for(int i=1;i<=page;i++) {
			totalRecos.addAll(totalRecoDAO.findSubmitRecoListsByFormid(dczjid, i, 1000, starttime, endtime));
		}
		return totalRecos;
	}
