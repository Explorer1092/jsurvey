...
public class ListJoinDetailController {
	...
	public ModelAndView showPage(String dczjid) {
		...
		String earnscore=totalReco.getSumscore();
		...
		modelAndView.addObject("earnscore", earnscore);
		return modelAndView;
	}
	
	@ResponseBody
	@RequestMapping("list")
	public String showList(String page,String limit,String dczjid,String starttime,String endtime,String check) {
		String data = "";
		//String delete = "";
		String type = "";
		String uuid = "";
		...
		List<TotalReco> totalRecos = totalRecoService.findSubmitRecoListsByFormid(dczjid, NumberUtil.getInt(page), NumberUtil.getInt(limit), starttime, endtime,check);
