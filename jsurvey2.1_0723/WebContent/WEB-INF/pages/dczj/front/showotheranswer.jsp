...
<div  style="padding:20px 20px;margin-left:150px;margin-right:150px;">
	<table width="100%" border="0" cellpadding="3" cellspacing="1" class="tb" style="background-color:white;">
	<tbody>
	<c:forEach var="entity" items="${recoList}" varStatus="status">
	<tr style="font-family:SimSun;color: white;">
<!-- 	<td width="10" height="35px"></td>
	<td width="10" height="35px"></td>
	<td width="10" height="35px" ></td>
	<td width="10"  height="35px"></td>  -->
	<td width="10" height="35px" colspan="9"  style="font-weight: bold; background-color:#35aaf4;padding-left:5px;">${quesname} :</td>
<%-- 	<td width="10"  height="35px">：</td>
	<td >${entity.answcontent}</td> --%>
	</tr>
	<tr style="font-family:SimSun;color: gray;">
	<td width="10" height="35px" colspan="9" style="padding:5px;padding-left:15px;">${entity.answcontent}</td>
	</tr>
	<tr style="font-family:SimSun;color: #35aaf4; height:36px;">
	...
	<tr >
	  ...
	  <td width="10" height="35px">：</td>
	  <td colspan="6" style="font-family:SimSun;color: gray;"></td>
	</tr>
	<tr >
	  <td colspan="8" style="font-family:SimSun;color: gray;padding-left:15px;padding-bottom:15px;">${entity.replycontent}</td>
	</tr>
