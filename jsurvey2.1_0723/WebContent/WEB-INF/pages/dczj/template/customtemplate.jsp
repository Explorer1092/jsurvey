...
function beforecommonsubmit(){
	...
	var str = '${contextPath}/manager/tempalte/showcommontemplateimport.do?dczjid=${dczjid}&type=${type}&pcPageCode='+encodeURIComponent(pcPageCode)+'&phonePageCode='+encodeURIComponent(phonePageCode);
	openDialog(str, 400, 200,{
	    	title : '上传图片'
	});
